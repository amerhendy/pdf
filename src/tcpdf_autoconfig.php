...
if (!defined('K_PATH_URL')) {
	$k_path_url = config('Amer.TCPDF.packagePath'); // default value for console mode
...
if (!defined('K_PATH_IMAGES')) {
	dd("SD");
	$tcpdf_images_dirs = array(config('Amer.TCPDF.packagePath').'examples/images/', config('Amer.TCPDF.packagePath').'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', config('Amer.TCPDF.packagePath'));
...
if (!defined('config('Amer.TCPDF.ImageScaleRatio')')) {
	define ('config('Amer.TCPDF.ImageScaleRatio')', 1.25);
}

if (!defined('config('Amer.TCPDF.HeadMagnification')')) {
	define('config('Amer.TCPDF.HeadMagnification')', 1.1);
}

if (!defined('config('Amer.TCPDF.CellHeightRation')')) {
	define('config('Amer.TCPDF.CellHeightRation')', 1.25);
}

if (!defined('config('Amer.TCPDF.TitleMagnifation')')) {
	define('config('Amer.TCPDF.TitleMagnifation')', 1.3);
}

if (!defined('config('Amer.TCPDF.SmallRetio')')) {
	define('config('Amer.TCPDF.SmallRetio')', 2/3);
}

if (!defined('config('Amer.TCPDF.ThaiTopchars')')) {
	define('config('Amer.TCPDF.ThaiTopchars')', true);
}

if (!defined('config('Amer.TCPDF.CallsInHTML')')) {
	define('config('Amer.TCPDF.CallsInHTML')', false);
}

if (!defined('config('Amer.TCPDF.TrowExeptionError')')) {
	define('config('Amer.TCPDF.TrowExeptionError')', false);
}
